    ...
    _createCellRenderers() {
        return {
            sequence: (cell, item, index, state) => {
                // [MODIFIED] (Phase 3) Removed sSetSelectedRowIndexes
                ...
                // [REMOVED] (Phase 3) Logic for sSetSelectedRowIndexes
                // else if (sSetSelectedRowIndexes.includes(index)) {
                //     cell.classList.add('sset-selection-highlight');
                // } 
